          ...
          <>
            ...
            <div className="mt-5 space-y-2.5">
              ...
              {student.passportStatus === 'active' && (
                <Button
                  variant="outline"
                  className="h-10 w-full justify-start rounded-xl border-[#d8e1ec] font-bold text-[#0e2347] shadow-sm"
                  onClick={handleDownload}
                  disabled={download.isFetching}
                  data-testid="button-download-admin-passport"
                >
                  <Download className="mr-2 h-4 w-4 text-[#165de8]" /> {download.isFetching ? 'Preparing PDF...' : 'Download Passport PDF'}
                </Button>
              )}
